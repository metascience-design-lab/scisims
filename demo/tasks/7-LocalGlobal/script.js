...
const study = new lab.flow.Sequence({
  content: [
    new lab.html.Screen({content: "<h1>Welcome to the Local Global Test!</h1><p>The test will consist of three two-minute blocks</p><p>Use the buttons 1-4 to input your responses</p><p>◯ = 1, X = 2, Δ = 3, □ = 4</p><p>Press the button corresponding either the local or global shape, as prompted</p><h2>Please press the SPACEBAR to continue</h2>", "responses": {'keypress(Space)': 'Continue'},}),
